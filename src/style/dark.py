# Main Window Compands

# Buttons
TOGGLE_BTN = """
    QPushButton {
        background-image: url(./src/icon/main-icons/menu.svg);
...
TOGGLE_BTN_CLOSE = """
    QPushButton {
        background-image: url(./src/icon/main-icons/icon_arrow_left.svg);
        background-position: left center;
        background-repeat: no-repeat;
        border: none;
        border-left: 22px solid rgb(20, 20, 20);
...
HOME_PAGE_BTN = """
    QPushButton {
        background-image: url(./src/icon/main-icons/home.svg);
        background-position: left center;
        background-repeat: no-repeat;
        border: none;
        border-left: 22px solid rgb(20, 20, 20);
...
HOME_LEFT_PAGE_BTN = """
    QPushButton {
        background-image: url(./src/icon/main-icons/trash-2.svg);
        background-position: left center;
        background-repeat: no-repeat;
        border: none;
        border-left: 22px solid rgb(20, 20, 20);
...
SEARCH_PAGE_BRN = """
    QPushButton {  
        background-image: url(./src/icon/main-icons/search.svg);
        background-position: left center;
        background-repeat: no-repeat;
        border: none;
        border-left: 22px solid rgb(20, 20, 20);
...
ANALYTICS_PAGE_BTN = """
    QPushButton {   
        background-image: url(./src/icon/24x24/bar-chart.png);
        background-position: left center;
        background-repeat: no-repeat;
        border: none;
        border-left: 22px solid rgb(20, 20, 20);
...
SETTING_PAGE_BTN = """
    QPushButton {  
        background-image: url(./src/icon/main-icons/settings.svg);
        background-position: left center;
        background-repeat: no-repeat;
        border: none;
        border-left: 22px solid rgb(20, 20, 20);
...
COMBO_BOX = """
    ...
    QComboBox::drop-down {
        ...
        background-image: url(./src/icon/16x16/cil-arrow-bottom.png);
...
LABEL_DOB_TEXT = """
    <p>&nbsp;
        <img src=\"./src/icon/16x16/cil-calendar-check.png\">&nbsp; &nbsp;
            <b>
                Date Of Birth
            </b>
    </p>
...
BTN_HIDDEN_ICON = "./src/icon/main-icons/chevron-up.svg"
BTN_OPENED_ICON = "./src/icon/main-icons/chevron-down.svg"


ICON_PHONE = "./src/icon/main-icons/phone.svg"
ICON_LOCK = "./src/icon/main-icons/lock.svg"
ICON_USER = "./src/icon/main-icons/user.svg"
ICON_AT = "./src/icon/16x16/cil-at.png"
ICON_LEVEL = "./src/icon/16x16/cil-level-up.png"
ICON_SEARCH = "./src/icon/main-icons/search.svg"
ICON_LOCATION = "./src/icon/16x16/cil-location-pin.png"
ICON_SUBJECT = "./src/icon/16x16/cil-lightbulb.png"
ICON_PEOPLE = "./src/icon/16x16/cil-people.png"
ICON_RIG_NUM = "./src/icon/16x16/cil-dialpad.png"
ICON_RIL = "./src/icon/16x16/cil-input.png"
ICON_ADD_USER = "./src/icon/main-icons/user-plus.svg"
ICON_GO = "./src/icon/main-icons/icon_arrow_left.svg"
ICON_DELETE = "./src/icon/main-icons/user-x.svg"
...
def setSuperUserIconName(name, label_widget):
...
ICON_LABEL_TEXT = """
    <html>
        ...
        <body>
            <p align=\"center\"><img src=\"./src/img/findupnew.png\"></p>
        </body>
    </html>
"""
...
ACTIVE_LABEL_INFO_TEXT = """
    <html>
        <head/>
        <body>
            <p>This <b>\"Delete\"</b> will Add into Recycle Bin </p>
        </body>
    </html>
"""
LAFT_LABEL_INFO_TEXT = """
    <html>
        <head/>
        <body>
            <p>This <b>\"Delete\"</b> will remove totally</p>
        </body>
    </html>
"""
