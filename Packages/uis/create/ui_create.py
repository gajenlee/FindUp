...
"}")
        ...
        self.verticalLayout_3.addWidget(self.label_logo, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
...
"#lineEdit_contact:focus {border: 3px solid rgb(39, 53, 84);}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setToolTip(_translate("MainWindow", "<p>Do You Want To Close ?,  Press <b>ESE</b> Key On Your Keybord</p><p>Do You Want To Confirm The Document ?,  Press The <b>ENTER</b> Key On Your Keybord</p>"))
        self.lineEdit_name.setToolTip(_translate("MainWindow", "5-Character Username"))
        self.lineEdit_name.setPlaceholderText(_translate("MainWindow", "Username"))
        self.lineEdit_pass.setToolTip(_translate("MainWindow", "6-Character Password"))
        self.lineEdit_pass.setPlaceholderText(_translate("MainWindow", "Password"))
        self.lineEdit_con_pass.setToolTip(_translate("MainWindow", "Reenter The Password"))
        self.lineEdit_con_pass.setPlaceholderText(_translate("MainWindow", "Repassword"))
        ...
        self.lineEdit_contact.setToolTip(_translate("MainWindow", "Contact Number"))
        self.lineEdit_contact.setPlaceholderText(_translate("MainWindow", "Contact Number"))
